...
export const ko: Dictionary = {
  ...
  pipeline: {
    ...
    steps: {
      ...
      compute: { label: '연산', desc: '수치 평가: 스칼라, 행렬, 복소수, 자동미분, 통계분포' },
  ...
  features: {
    ...
    evaluator: {
      title: '수치 평가자',
      desc: '스칼라·행렬·복소수·자동미분에 통계분포까지. 동기, AST 기반, 프레임워크 무관.',
    },
    visualization: {
      title: '자동 시각화',
  ...
  pipelineExplorer: {
    ...
    steps: {
      ...
      compute: { title: '연산', desc: 'AST 수치 평가 (스칼라/행렬/복소수/자동미분)' },
      visualize: { title: '시각화', desc: '수식에 맞게 자동 선택된 시각화' },
    },
    click_to_expand: '클릭하여 펼치기',
    no_compute: '이 수식을 평가할 수 없습니다.',
    no_viz: '이 수식에 사용 가능한 시각화가 없습니다.',
    loading: '계산 중...',
    compute_form: '형태',
    compute_free_vars: '자유 변수',
    compute_value: '값',
  },
  examples: {
    title: '예제 갤러리',
  ...
  pluginsPage: {
    ...
    arch: {
      ...
      core_desc: 'LaTeX 파서, TeX 박스 모델 렌더러, 수식 분석기, 수치 평가자(스칼라/행렬/복소수/자동미분), 시각화 컴포넌트. 프레임워크 무관, DOM 의존성 없음.',
