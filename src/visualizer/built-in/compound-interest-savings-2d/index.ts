...
export default (function create(): FizzexVisualizer {
  ...
  return {
    ...
    parameters: [
      ...
      { id: 't', name: 't', role: '경과 (년)', min: 0, max: 30, default: 10, step: 0.5, unit: '년' },
    ],
    ...
    mount(container, options) {
      renderer = new CompoundInterestSavingsRenderer(container, options);
    },
    update(context) {
