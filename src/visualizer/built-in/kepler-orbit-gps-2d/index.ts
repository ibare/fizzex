/**
 * 케플러 제3법칙 — GPS 위성 2D 궤도.
 *
 * T² = (4π² / GM) · a³. 기본 a=26,560 km(고도 ≈ 20,200 km, 약 12시간 주기).
 */

import type { FizzexVisualizer, ParameterValues, ComputeContext } from '../../types';
import { KeplerOrbitGpsRenderer } from './renderer';
...
export default (function create(): FizzexVisualizer {
  let renderer: KeplerOrbitGpsRenderer | null = null;

  return {
    id: 'kepler-orbit-gps-2d',
    name: 'GPS 위성 궤도',
    ...
    mount(container, options) {
      renderer = new KeplerOrbitGpsRenderer(container, options);
    },
    update(context) {
