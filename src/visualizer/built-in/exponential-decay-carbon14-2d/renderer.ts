 ...
 * 탄소-14 지수 감소 렌더러.
 *
 * 상단 42% N/N₀ 감소 곡선, 하단 58% 원자 그리드 + 유물 실루엣.
 */
...
import { drawCarbon14 } from '../_shared/exponential-decay/carbon14';
import { LN2, decayRatio, halfLifeFromR } from '../_shared/exponential-decay/math';

const BRAND_COLOR = '#7C3AED';
const TOP_RATIO = 0.42;
const DEFAULT_R = -LN2 / 8;

export class ExponentialDecayCarbon14Renderer {
