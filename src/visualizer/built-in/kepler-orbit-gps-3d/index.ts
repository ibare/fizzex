/**
 * 케플러 제3법칙 — GPS 위성 3D 궤도 (Three.js).
 */

import type { FizzexVisualizer, ParameterValues, ComputeContext } from '../../types';
import { KeplerOrbitGps3DRenderer } from './renderer';
...
export default (function create(): FizzexVisualizer {
  let renderer: KeplerOrbitGps3DRenderer | null = null;

  return {
    id: 'kepler-orbit-gps-3d',
    name: 'GPS 3D 궤도',
    ...
    mount(container, options) {
      renderer = new KeplerOrbitGps3DRenderer(container, options);
    },
    update(context) {
