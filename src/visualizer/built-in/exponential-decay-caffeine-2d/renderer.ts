 ...
 * 카페인 지수 감소 렌더러.
 *
 * 상단 42% N/N₀ 감소 곡선 + 반감기 마커, 하단 58% 커피 컵 수위 장면.
 */
...
import { drawCaffeine } from '../_shared/exponential-decay/caffeine';
import { LN2, decayRatio, halfLifeFromR } from '../_shared/exponential-decay/math';

const BRAND_COLOR = '#92400E';
const TOP_RATIO = 0.42;
const DEFAULT_R = -LN2 / 5;

export class ExponentialDecayCaffeineRenderer {
