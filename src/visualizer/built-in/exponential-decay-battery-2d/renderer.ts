 ...
 * 배터리 방전 지수 감소 렌더러.
 *
 * 상단 42% N/N₀ 감소 곡선, 하단 58% 배터리 아이콘 + 색상 변화.
 */
...
import { drawBattery } from '../_shared/exponential-decay/battery';
import { LN2, decayRatio, halfLifeFromR } from '../_shared/exponential-decay/math';

const BRAND_COLOR = '#0EA5E9';
const TOP_RATIO = 0.42;
const DEFAULT_R = -LN2 / 3;

export class ExponentialDecayBatteryRenderer {
