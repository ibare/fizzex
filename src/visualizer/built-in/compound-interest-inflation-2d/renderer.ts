 ...
 * 인플레이션 렌더러.
 *
 * 상단 42%는 구매력(P²/A) 역방향 곡선, 하단 58%는 장바구니 크기 감소 장면.
 */
...
import { drawInflation } from '../_shared/compound-interest/inflation';
...
export class CompoundInterestInflationRenderer {
  ...
  private render(ctx: CanvasRenderingContext2D, w: number, h: number): void {
    ...
    drawAbstract({
      ...
      isStandard: this.isStandard, tMax: T_MAX, inverse: true,
