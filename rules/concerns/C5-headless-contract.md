...
## MUST
- `FizzexRenderer`와 `FizzexEditor`의 public API(constructor, render, setLatex, getLatex, onChange, destroy)는 하위 호환성을 유지한다
...
- `FizzexRenderer.render()`가 예외를 throw하지 않는다 (잘못된 LaTeX도 silent fail)
